// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.4.0-132.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    convertNativeToDart_Dictionary(object) {
      ...
      t1.toString;
      for (t1 = B.JSArray_methods.get$iterator(t1); A.boolConversionCheck(t1.moveNext$0());) {
  ...
  A.MapBase.prototype = {
    forEach$1(receiver, action) {
      ...
      for (t2 = J.get$iterator$ax(this.get$keys(receiver)), t1 = t1._eval$1("MapBase.V"); A.boolConversionCheck(t2.moveNext$0());) {
  ...
  A.Iterable.prototype = {
    ...
    get$isEmpty(_) {
      return !A.boolConversionCheck(this.get$iterator(0).moveNext$0());
    },
    get$isNotEmpty(_) {
      return !A.boolConversionCheck(this.get$isEmpty(0));
    },
  ...
  A.Element.prototype = {
    get$localName(receiver) {
      var t1 = this.get$_localName(receiver);
      t1.toString;
      return t1;
    },
    toString$0(receiver) {
  ...
  A._DomRectList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._DomRectList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._DomStringList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._DomStringList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._FileList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._FileList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._HtmlCollection_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._HtmlCollection_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._MidiInputMap_JavaScriptObject_MapMixin.prototype = {$isMapBase: 1, $isMap: 1};
  A._MidiOutputMap_JavaScriptObject_MapMixin.prototype = {$isMapBase: 1, $isMap: 1};
  A._MimeTypeArray_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._MimeTypeArray_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._NodeList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._NodeList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._PluginArray_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._PluginArray_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._RtcStatsReport_JavaScriptObject_MapMixin.prototype = {$isMapBase: 1, $isMap: 1};
  A._SourceBufferList_EventTarget_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._SourceBufferList_EventTarget_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._SpeechGrammarList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._SpeechGrammarList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._Storage_JavaScriptObject_MapMixin.prototype = {$isMapBase: 1, $isMap: 1};
  A._TextTrackCueList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._TextTrackCueList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._TextTrackList_EventTarget_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._TextTrackList_EventTarget_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._TouchList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._TouchList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A.__CssRuleList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A.__CssRuleList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A.__GamepadList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A.__GamepadList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A.__NamedNodeMap_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A.__NamedNodeMap_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A.__SpeechRecognitionResultList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A.__SpeechRecognitionResultList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A.__StyleSheetList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A.__StyleSheetList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  ...
  A.LengthList.prototype = {
    ...
    $index(receiver, index) {
      var t1;
      A._asInt(index);
      t1 = index >>> 0 !== index || index >= this.get$length(receiver);
      t1.toString;
      if (t1)
    ...
    getItem$1(receiver, index) {
      var t1 = receiver.getItem(A._asInt(index));
      t1.toString;
      return t1;
    },
    $isEfficientLengthIterable: 1,
  ...
  A._LengthList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._LengthList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._NumberList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._NumberList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._StringList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._StringList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  A._TransformList_JavaScriptObject_ListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1};
  A._TransformList_JavaScriptObject_ListMixin_ImmutableListMixin.prototype = {$isEfficientLengthIterable: 1, $isHideEfficientLengthIterable: 1, $isListBase: 1, $isIterable: 1, $is_ListIterable: 1, $isList: 1, $isImmutableListMixin: 1};
  ...
  A._AudioParamMap_JavaScriptObject_MapMixin.prototype = {$isMapBase: 1, $isMap: 1};
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A._Required, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A._UnmodifiableMapMixin, A.Null, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString, A.WebGL]);
...
//# sourceMappingURL=extension.dart.js.map
