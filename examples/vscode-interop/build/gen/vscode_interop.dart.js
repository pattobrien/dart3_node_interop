...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    isToStringVisiting(object) {
      var t2,
        t1 = J.getInterceptor$as($.toStringVisiting),
        i = 0;
      while (true) {
    ...
    StringBuffer__writeAll(string, objects, separator) {
      var iterator = B.JSArray_methods.get$iterator(objects);
    ...
    Iterable_iterableToFullString(iterable, leftDelimiter, rightDelimiter) {
      ...
      t1 = J.getInterceptor$a($.toStringVisiting);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Error, [A.LateError, A._CyclicInitializationError, A.RuntimeError, A.AssertionError, A._Error, A.TypeError, A.ArgumentError, A.UnsupportedError, A.ConcurrentModificationError]);
