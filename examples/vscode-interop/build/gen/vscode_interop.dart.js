...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main($arguments) {
      A.print("Hello world!");
      A.allowInteropCaptureThis(A.vscode_interop___activateImpl$closure());
      A.print("Extension methods have been set!");
    },
    ...
    allowInteropCaptureThis(f) {
      if (A.boolConversionCheck(A.isJSFunction(f)))
        throw A.wrapException(A.ArgumentError$("Function is already a JS function so cannot capture this."));
      else
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "vscode_interop___activateImpl$closure", "_activateImpl", 7);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A._Required, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A._UnmodifiableMapMixin, A.Null, A.StringBuffer]);
    ...
    _inherit(A._activateImpl_closure, A.Closure0Args);
...
//# sourceMappingURL=vscode_interop.dart.js.map
